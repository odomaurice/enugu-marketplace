...
import { InventoriesList } from '@/components/dashboards/agent/inventories/InventoriesList';
import { CreateInventoryDialog } from '@/components/dashboards/agent/inventories/CreateInventoryDialog';
