...
import MobileSideBar from "@/components/dashboards/agent/sidebar/MobileSidebar";
import MobileNavbar from "@/components/dashboards/agent/navbar/MobileNavbar";
import Sidebar from "@/components/dashboards/agent/sidebar/Sidebar";
  ...
  return (
    <div className="flex font-header">
      ...
      <div className="hidden sm:block sm:flex-4 md:flex-2 bg-[#FFF] text-black font-semibold py-2 h-screen sticky top-0 overflow-auto scrollbar-hide">
        <Sidebar dashboard="fulfillment_officer"  />
      ...
      <section className="flex-1 flex flex-col w-full overflow-hidden">
        ...
        <div className="sm:hidden">
          <MobileSideBar dashboard="fulfillment_officer" session={session}  />
        </div>
