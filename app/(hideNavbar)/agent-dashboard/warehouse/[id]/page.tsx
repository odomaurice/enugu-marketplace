...
import { WarehouseDetails } from '@/components/dashboards/agent/warehouses/WarehouseDetails';
...
export default async function WarehouseDetailsPage({
  ...
  try {
    const res = await axios.get(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}/agent/warehouse?warehouse_id=${id}`,
      {
    ...
    redirect('/agent-dashboard/warehouse');
  }
